...
/** First accordion header label (click to expand). */
export const ITINERARY_ACCORDION_TITLE = 'Scopri l\'itinerario';

/** Second accordion header label (click to expand). */
export const PREFERENCES_ACCORDION_TITLE = 'Vedi se ho azzeccato i tuoi gusti';

/** Payoff shown inside open preferences accordion, above panels. */
...
/** Initial proposal screen — system suggestions from profile, not yet confirmed. */
